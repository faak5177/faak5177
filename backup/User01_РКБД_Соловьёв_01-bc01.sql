-- =============================================================
-- Резервная копия базы данных SQLite "demoekz.db"
-- Автор: Соловьёв Георгий Александрович
-- Дата:  19.06.2026
-- КОД:  09.02.07-2-2026-П(В), вариативный модуль 1
-- Команда получения: sqlite3 demoekz.db .dump > User01_РКБД_Соловьёв_01-bc01.sql
-- Команда восстановления: sqlite3 demoekz_restored.db < User01_РКБД_Соловьёв_01-bc01.sql
-- =============================================================
